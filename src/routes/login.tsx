...
function LoginPage() {
  ...
  return (
    <AuthLayout
      title="Welcome back"
      subtitle="Sign in to your Pilot account"
      onSubmit={submit}
      error={error}
      loading={loading}
      email={email}
    ...
    <div className="flex h-screen flex-col items-center justify-center bg-background px-4">
      ...
      >
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-agent text-white hover:bg-agent/90"
            disabled={loading}
          >
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          {altText}{" "}
          <a href={altLink} className="font-medium text-agent hover:underline">
            {altLinkText}
          </a>
        </p>
      </motion.div>
